...
#define AME_OK 0
#define AME_EOF -1
#define AME_MAXOPENFILES 1
#define AME_FILE_NOT_OPEN 2
#define AME_FILE_OPEN 3
#define AME_REMOVE_FAIL 4
#define AME_INVALID_attrLENGTH 5
#define AME_SCAN_NOT_EXIST 6
